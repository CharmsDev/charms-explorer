                ...
                <footer className="relative z-10 bg-dark-900/80 backdrop-blur-sm border-t border-dark-800 text-white py-8 mt-12">
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col md:flex-row justify-between items-start">
                            ...
                            {/* Community Column */}
                            <div className="mb-6 md:mb-0">
                                <h3 className="text-xs font-semibold text-white mb-2">Community</h3>
                                <ul className="space-y-1.5">
                                    <li>
                                        <a
                                            ...
                                            className="text-dark-300 hover:text-primary-400 transition-colors text-xs"
                                        >
                                            Charms Docs
                                        </a>
                                    </li>
                            ...
                            <div className="mb-6 md:mb-0">
                                ...
                                <ul className="space-y-1.5">
                                    <li>
                                        <a href="#" className="text-dark-300 hover:text-primary-400 transition-colors text-xs">
                                            Contact Us
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div className="flex flex-col items-end">
                                <div className="flex flex-col mb-3">
                                    <div className="flex space-x-4">
                                        <a href="https://x.com/CharmsDev" target="_blank" rel="noopener noreferrer" className="text-dark-400 hover:text-primary-400 transition-colors">
