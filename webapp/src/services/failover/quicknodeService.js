/**
 * [FAILOVER / LEGACY] QuickNode Bitcoin RPC Service
 *
 * This module is kept as a failover provider for Bitcoin transaction lookups.
 * Primary path: Explorer API (/v1/wallet/tx/{txid})
 * Failover 1:  QuickNode (this file)
 * Failover 2:  Mempool.space public API
 *
 * If the Explorer API fully covers all tx lookup needs, this file can be removed.
 */
