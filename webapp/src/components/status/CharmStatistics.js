...
export default function CharmStatistics({ charmStats }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-dark-800 to-dark-900 rounded-lg overflow-hidden shadow-lg">
                <div className="p-6">
                    <h2 className="text-xl font-semibold text-white mb-4">Charm Statistics</h2>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-dark-800/50 p-4 rounded-lg hover:bg-dark-800/70 transition-colors">
            ...
            <div className="bg-gradient-to-br from-dark-800 to-dark-900 rounded-lg overflow-hidden shadow-lg">
                <div className="p-6">
                    <h2 className="text-xl font-semibold text-white mb-4">Charms by Asset Type</h2>
