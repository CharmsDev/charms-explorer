...
# redeploy.sh
# Redeploys an existing charms-indexer application to Fly.io.
...
echo "🔄 Starting redeployment of charms-indexer to Fly.io..."
...
echo "🎉 Redeployment of charms-indexer successful!"
